...
export class HomePage {
  ...
  sessionReadyHandler(e) {
    ...
    document.getElementById("miID").appendChild(document.createTextNode("\n Mi ID: "+this.myCallId));
  ...
  InitializeControls() {
    ...
    document.getElementById("miID").appendChild(document.createTextNode("<br>Controles Iniciados..."));
  }
  ...
  InitializeControlsForIncomingCall() {
    ...
    this.nativeAudio.loop('uniqueI1').then((succ)=>{
      ...
      document.getElementById("miID").appendChild(document.createTextNode("<br>Controles llamadas entrantes... Succ" + succ));
    }, (err)=>{
      console.log("err",err)
      document.getElementById("miID").appendChild(document.createTextNode("<br>Controles llamadas entrantes... Err" + err));
    });
  ...
  AddEventListeners() {
    ...
    apiRTC.addEventListener("userMediaError", (e) => {
      ...
      document.getElementById("miID").appendChild(document.createTextNode("<br>" + this.status + "<br/> The following error has occurred <br/> " + e));
    });
